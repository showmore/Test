...
if __name__ == '__main__':
    data = {'gs_name': '深圳市东健宇电子有限公司', 'job_link': 'http://jobs.51job.com/shenzhen/86494101.html?s=01&t=0', \
    'job_site': '深圳', 'salary': '4.5-6千/月', 'gs_link': 'http://jobs.51job.com/all/co2628963.html', \
    'job_name': '淘宝/天猫运营', 'create_date': '07-15'}
