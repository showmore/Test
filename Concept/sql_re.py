...
cur = conn.cursor() 
cur.execute('SELECT project_info_id,technology_info FROM tbu_zy_project_info where technology_info is not null and technology_info not like \'%<%\' order by  create_time DESC ') 
r = cur.fetchall()
